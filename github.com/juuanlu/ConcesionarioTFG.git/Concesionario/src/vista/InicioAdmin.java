...
public class InicioAdmin {
	...
	public static void main(String[] args) {
		try {
			InicioAdmin window = new InicioAdmin();
			window.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	protected void createContents() {
		...
		lblTitulo.setText("Creaci\u00F3n de cuentas solo apta para administradores.");
		...
		btnEntrar.setText("Acceder a crear cuenta");
		btnEntrar.setBounds(129, 182, 188, 38);
